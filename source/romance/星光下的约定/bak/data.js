...
const storyData = {
    ...
    // 其他类型游戏的statsConfig示例
    // 
    // 示例1：冒险游戏
    // statsConfig: [
    //     { label: "生命值", key: "health", type: "number" },
    ...
    // 示例2：恋爱游戏
    // statsConfig: [
    //     { label: "好感度", key: "affection", type: "number" },
    ...
    //     { label: "状态", key: "status", type: "traits" }
    // ]
    ...
    scenes: {
        ...
        exchange_contact: {
            ...
            choices: [
                {
                    text: "继续探索合作的可能性",
                    nextScene: "transition_collaboration_1",
                    effects: { relationship: 5 }
                },
                {
                    text: "重新开始故事",
        ...
        farewell: {
            ...
            choices: [
                {
                    text: "思考这次离别对人生的意义",
                    nextScene: "transition_parting_1",
                    effects: { relationship: 3 }
                },
                {
                    text: "重新开始故事",
        ...
        buddhist_wisdom: {
            ...
            choices: [
                {
                    text: "继续探讨智慧与艺术的关系",
                    nextScene: "transition_artistic_1",
                    effects: { relationship: 8 }
                },
                {
                    text: "重新开始故事",
        ...
        protect_sketchbook: {
            ...
            choices: [
                {
                    text: "思考这次意外相遇的意义",
                    nextScene: "transition_surprise_1",
                    effects: { relationship: 8 }
                },
                {
                    text: "重新开始故事",
        ...
        // 过渡场景1：合作创作结局的收敛
        transition_collaboration_1: {
            background: "",
            text: `
                <p>经过一段时间的合作，你们发现彼此的艺术理念越来越契合。</p>
                <p>林雨晴看着你们的合作作品，微笑着说："我们的创作越来越有默契了。"</p>
                <p>你们开始思考，这种默契的合作关系应该走向何方？</p>
            `,
            choices: [
                {
                    text: "继续深入合作，建立长期艺术伙伴关系",
                    nextScene: "transition_collaboration_2",
                    effects: { relationship: 10 }
                },
                {
                    text: "保持现状，享受当下的创作乐趣",
                    nextScene: "transition_collaboration_3",
                    effects: { relationship: 5 }
                }
            ]
        },
        ...
        // 过渡场景2：艺术成就的深化
        transition_collaboration_2: {
            background: "",
            text: `
                <p>你们决定将合作关系提升到新的高度。</p>
                <p>"我们可以尝试一些更具挑战性的创作项目，"林雨晴提议道，"让我们的艺术之路走得更远。"</p>
                <p>你们开始规划未来的艺术发展方向。</p>
            `,
            choices: [
                {
                    text: "专注于艺术探索，追求更高的艺术成就",
                    nextScene: "main_ending_artistic",
                    effects: { relationship: 15, traits: { art: true } }
                },
                {
                    text: "平衡艺术与生活，寻找更全面的发展",
                    nextScene: "main_ending_balanced",
                    effects: { relationship: 10 }
                }
            ]
        },
        ...
        // 过渡场景3：艺术与情感的平衡
        transition_collaboration_3: {
            background: "",
            text: `
                <p>你们享受着当下的创作时光，但也在思考更深层次的联系。</p>
                <p>"除了艺术合作，我们之间似乎还有更多值得珍惜的东西，"林雨晴若有所思地说。</p>
                <p>你们开始探讨艺术合作之外的可能性。</p>
            `,
            choices: [
                {
                    text: "将合作关系发展为更深的情感联系",
                    nextScene: "main_ending_emotional",
                    effects: { relationship: 20 }
                },
                {
                    text: "保持纯粹的艺术伙伴关系",
                    nextScene: "main_ending_friendship",
                    effects: { relationship: 8 }
                }
            ]
        },
        ...
        // 过渡场景4：艺术成就的反思
        transition_artistic_1: {
            background: "",
            text: `
                <p>在艺术创作的道路上，你们各自取得了不小的成就。</p>
                <p>"我们的艺术理念虽然不同，但都找到了属于自己的表达方式，"林雨晴感慨道。</p>
                <p>你们开始思考个人艺术成就与共同成长的关系。</p>
            `,
            choices: [
                {
                    text: "追求更高的个人艺术成就",
                    nextScene: "main_ending_personal",
                    effects: { relationship: 5 }
                },
                {
                    text: "将个人成就融入更大的艺术愿景",
        ...
        // 过渡场景5：离别遗憾的反思
        transition_parting_1: {
            background: "",
            text: `
                <p>虽然分别的时刻总是让人不舍，但这次相遇却给你们留下了深刻的印记。</p>
                <p>"有时候，短暂的相遇反而能成为最珍贵的回忆，"林雨晴轻声说道。</p>
                <p>你们开始思考这次离别对各自人生的意义。</p>
            `,
            choices: [
                {
                    text: "将这次经历转化为个人成长的动力",
                    nextScene: "transition_parting_2",
                    effects: { relationship: 3 }
                },
                {
                    text: "珍惜当下的美好，期待未来的重逢",
                    nextScene: "transition_emotional_1",
                    effects: { relationship: 8 }
                }
            ]
        },
        ...
        // 过渡场景6：情感发展的深化
        transition_emotional_1: {
            background: "",
            text: `
                <p>你们之间的情感联系在不知不觉中加深。</p>
                <p>"我没想到能在峨眉山遇到如此投缘的人，"林雨晴真诚地说。</p>
                <p>你们开始探讨这种情感联系的发展方向。</p>
            `,
            choices: [
                {
                    text: "让情感自然发展，顺其自然",
                    nextScene: "transition_emotional_2",
                    effects: { relationship: 12 }
                },
                {
                    text: "将情感转化为持久的友谊",
        ...
        // 过渡场景7：意外收获的整合
        transition_surprise_1: {
            background: "",
            text: `
                <p>这次峨眉山之旅给你们带来了许多意想不到的收获。</p>
                <p>"有时候，最美的风景不在计划之中，"林雨晴微笑着说。</p>
                <p>你们开始思考如何将这些意外收获融入各自的生活。</p>
            `,
            choices: [
                {
                    text: "将这些收获转化为新的创作灵感",
                    nextScene: "transition_surprise_2",
                    effects: { relationship: 7 }
                },
                {
                    text: "让这些美好经历成为人生的宝贵财富",
                    nextScene: "main_ending_personal",
                    effects: { relationship: 5 }
                }
            ]
        ...
        transition_other_1: {
            background: "",
            text: `
                <p>这次相遇虽然短暂，却在你们各自的人生中留下了独特的印记。</p>
                <p>"每个人的相遇都有其独特的意义，"林雨晴若有所思地说。</p>
                <p>你们开始思考这次相遇对各自人生的影响。</p>
            `,
            choices: [
                {
                    text: "将这次经历融入个人成长历程",
                    nextScene: "transition_other_2",
                    effects: { relationship: 4 }
                },
                {
                    text: "珍惜当下的缘分，期待未来的可能性",
                    nextScene: "transition_emotional_1",
                    effects: { relationship: 6 }
                }
            ]
        ...
        // 过渡场景9：离别遗憾的最终收敛
        transition_parting_2: {
            background: "",
            text: `
                <p>离别虽然让人伤感，但也让你们更加珍惜曾经的美好。</p>
                <p>"有时候，适当的距离反而能让关系更加珍贵，"林雨晴轻声说道。</p>
                <p>你们开始思考如何让这次离别成为新的开始。</p>
            `,
            choices: [
                {
                    text: "将离别转化为个人成长的契机",
        ...
        // 过渡场景10：情感发展的最终选择
        transition_emotional_2: {
            background: "",
            text: `
                <p>你们之间的情感联系已经发展到了需要做出选择的时刻。</p>
                <p>"感情的事情需要时间和耐心，"林雨晴认真地说。</p>
                <p>你们开始思考这段关系的未来走向。</p>
            `,
            choices: [
                {
        ...
        // 过渡场景11：意外收获的最终整合
        transition_surprise_2: {
            background: "",
            text: `
                <p>这些意外收获已经开始影响你们的创作和生活。</p>
                <p>"有时候，意外的发现反而能带来最真实的灵感，"林雨晴感慨道。</p>
                <p>你们开始思考如何将这些收获转化为持久的价值。</p>
            `,
            choices: [
                {
                    text: "将收获融入艺术创作",
                    nextScene: "main_ending_artistic",
                    effects: { relationship: 10, traits: { art: true } }
                },
                {
                    text: "将收获转化为人生智慧",
                    nextScene: "main_ending_personal",
        ...
        transition_other_2: {
            background: "",
            text: `
                <p>这次相遇的意义在时间的沉淀中逐渐清晰。</p>
                <p>"每一个相遇都是命运的安排，"林雨晴微笑着说。</p>
                <p>你们开始理解这次相遇在各自人生中的位置。</p>
            `,
            choices: [
                {
                    text: "将这次经历视为人生的宝贵财富",
        ...
        transition_final_1: {
            background: "",
            text: `
                <p>经过这段时间的相处，你们对彼此有了更深的了解。</p>
                <p>"我们的相遇就像峨眉山的云雾，美丽而神秘，"林雨晴诗意地说。</p>
                <p>你们开始思考这段关系的最终走向。</p>
            `,
            choices: [
                {
                    text: "让关系自然发展，顺其自然",
                    nextScene: "transition_final_2",
                    effects: { relationship: 15 }
                },
                {
                    text: "做出明确的选择，确定关系方向",
                    nextScene: "transition_final_3",
                    effects: { relationship: 10 }
                }
            ]
        },
        ...
        transition_final_2: {
            ...
            text: `
                <p>时间让一切变得更加清晰。</p>
                <p>"有时候，最自然的发展就是最好的选择，"林雨晴平静地说。</p>
                <p>你们已经找到了最适合彼此的相处方式。</p>
            `,
            choices: [
                {
                    text: "保持这种自然而美好的关系",
        ...
        transition_final_3: {
            ...
            text: `
                <p>现在是做出最终决定的时候了。</p>
                <p>"无论选择什么，我都会尊重你的决定，"林雨晴真诚地说。</p>
                <p>你们都知道，这个选择将决定你们关系的最终走向。</p>
            `,
            choices: [
                {
                    text: "专注于艺术合作，建立专业伙伴关系",
                    nextScene: "main_ending_artistic",
                    effects: { relationship: 15, traits: { art: true } }
                },
                {
        ...
        // 主要结局1：艺术合作结局
        main_ending_artistic: {
            background: "",
            text: `
                <p>你们选择了专注于艺术合作的道路。</p>
                <p>在接下来的几年里，你们共同创作了许多令人惊叹的艺术作品，成为了艺术界备受瞩目的合作伙伴。</p>
                <p>林雨晴说："我们的合作让彼此的艺术都达到了新的高度。"</p>
                <p><strong>结局：艺术合作</strong></p>
                <p>你们的艺术合作不仅创造了美丽的作品，更在彼此的生命中留下了深刻的印记。</p>
            `,
            choices: [
                {
                    text: "重新开始故事",
        ...
        // 主要结局2：情感共鸣结局
        main_ending_emotional: {
            background: "",
            text: `
                <p>你们选择了发展情感联系的道路。</p>
                <p>随着时间的推移，你们的关系从最初的相遇逐渐发展为深厚的感情，成为了彼此生命中最重要的存在。</p>
                <p>林雨晴说："峨眉山的那次相遇，改变了我的一生。"</p>
                <p><strong>结局：情感共鸣</strong></p>
                <p>真正的缘分不在于相遇的偶然，而在于相遇后的珍惜与坚持。</p>
            `,
            choices: [
                {
                    text: "重新开始故事",
        ...
        // 主要结局3：个人成长结局
        main_ending_personal: {
            background: "",
            text: `
                <p>你们选择了各自发展的道路。</p>
                <p>虽然选择了不同的方向，但这次相遇成为了你们各自成长的重要契机。</p>
                <p>林雨晴说："有时候，适当的距离反而能让彼此更好地成长。"</p>
                <p><strong>结局：个人成长</strong></p>
                <p>真正的相遇不是占有，而是让彼此成为更好的自己。</p>
            `,
            choices: [
                {
                    text: "重新开始故事",
        ...
        // 主要结局4：平衡发展结局
        main_ending_balanced: {
            background: "",
            text: `
                <p>你们选择了平衡发展的道路。</p>
                <p>在艺术合作与个人生活之间找到了完美的平衡，既保持了创作的激情，又享受了生活的美好。</p>
                <p>林雨晴说："生活就像艺术，需要平衡才能完美。"</p>
                <p><strong>结局：平衡发展</strong></p>
                <p>最美好的关系是让彼此都能在平衡中成长。</p>
            `,
            choices: [
                {
                    text: "重新开始故事",
        ...
        // 主要结局5：友谊发展结局
        main_ending_friendship: {
            background: "",
            text: `
                <p>你们选择了保持友谊的道路。</p>
                <p>这份纯粹的友谊在时间的沉淀中变得更加珍贵，成为了彼此生命中不可或缺的支持。</p>
                <p>林雨晴说："真正的友谊比任何关系都更加持久。"</p>
                <p><strong>结局：友谊发展</strong></p>
                <p>有时候，最美好的关系就是最简单的友谊。</p>
            `,
            choices: [
                {
                    text: "重新开始故事",
