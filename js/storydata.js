    ...
    mystery: {
        ...
        stories: [
...

            {
                ...
                author: "传习者戚",
                cover: "images/03.png",
                description: "故事根据真实事件改编。上世纪六七十年代的一个初秋，吉林省榆树县东南花园山脚下，有人在山坡上发现了印有洋文的罐头盒。地方干部满脑子阶级斗争新动向，执意断定吃罐头的特务及其内奸就在附近。作为大案要案迅速部署揪敌特审内奸行动。刻意营造高压态势，急于贪图立功表现。一时事态失控，牵连众多无辜之人。最终酿成盲目猜忌、互相构陷的荒唐案。而改编内容纯属虚构，不影射任何真实事件与人物，请勿对号入座。如有雷同，纯属移花接木、道听途说。",
                tags: "危机反转，离奇荒诞",
                status: "可试读......修改中",
                externalLink: "./source/mystery/花园山奇案/index.html",
                isRecommended: true,
                recommendReason: "当年发生在花园山的敌特冤案真相，随着岁月的流逝已经很难复原了。借助于当年知情者的回忆讲述，编写出一个多版本的虚拟故事。试图还原特定年代混乱时期的错误乱象，使人们铭记历史教训，珍惜当下法治公正、文明和谐的社会环境。意外反转，离奇荒诞，文风略显讽刺幽默。每次打开版本会随机选择，情节各有不同。"
            }
