    ...
    mystery: {
        ...
        stories: [
...

            {
                ...
                author: "传习者戚",
                cover: "images/03.png",
                description: "故事根据真实事件改编。上世纪六十年代一个初秋，吉林省榆树县东南花园山脚下的光明公社祥顺大队，有人在山坡上发现了印有洋文的罐头盒。地方干部满脑子阶级斗争新动向，执意断定吃罐头的特务及其内奸就在附近。迅速部署揪敌特审内奸行动。刻意造势，贪图功名。一时事态失控，酿成牵连众多无辜之人的荒诞冤案。",
                tags: "危机反转，离奇荒诞",
                status: "可试读......修改中",
                externalLink: "./source/mystery/花园山奇案/index.html",
                isRecommended: true,
                recommendReason: "当年发生在花园山的敌特冤案真相，随着岁月的流逝已经很难复原了。借助于当年知情者的回忆讲述，大致演绎出了一个多版本虚拟故事。试图还原特定年代混乱时期的错误乱象，使人们铭记历史教训，珍惜当下法治公正、文明和谐的社会环境。每次打开都是版本不同的讲述。"
            }
